...
<template>
  <div class="btn btn-outline btn-sm text-gray-900 dark:text-neutral-100 m-1 text-center btn-circle">
    <label class="swap swap-rotate">
      <input v-model="colorMode" type="checkbox" true-value="light" false-value="dark" />
